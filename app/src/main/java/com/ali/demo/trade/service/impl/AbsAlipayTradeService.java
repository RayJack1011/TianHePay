...
import com.ali.demo.api.request.AlipayTradeCancelRequest;
import com.ali.demo.api.request.AlipayTradePrecreateRequest;
import com.ali.demo.api.request.AlipayTradeQueryRequest;
import com.ali.demo.api.request.AlipayTradeRefundRequest;
...
abstract class AbsAlipayTradeService extends AbsAlipayService implements AlipayTradeService {
    ...
    public AlipayF2FQueryResult queryTradeResult(AlipayTradeQueryRequestBuilder builder) {
        ...
        Log.e("qqq","支付宝回参----->"+new Gson().toJson(result)+"");
    ...
    public AlipayF2FRefundResult tradeRefund(AlipayTradeRefundRequestBuilder builder) {
        validateBuilder(builder);
        Log.e("qqq",new Gson().toJson(builder)+"::::::::::::::支付宝退款入参");
        ...
        Log.e("qqq","支付宝退款回参----->"+new Gson().toJson(response)+"");
    ...
    // 交易等待付款
    protected boolean queryWaiting(AlipayTradeQueryResponse response) {
        return response != null &&
                Constants.SUCCESS.equals(response.getCode()) &&
