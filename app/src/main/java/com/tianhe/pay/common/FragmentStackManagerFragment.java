...
/**
 * source code from:
 * com.raizlabs.coreutils.app.FragmentStackManagerFragment
 */
public class FragmentStackManagerFragment extends Fragment {
    ...
    /**
     * Creates a new {@link com.raizlabs.coreutils.app.FragmentStackManagerFragment} which maintains a
     * stack inside the given container id.
     * @param containerID The ID of the container to commit fragments to.
     * @return The new {@link com.raizlabs.coreutils.app.FragmentStackManagerFragment} instance
     */
