...
public class ReportReqData {
    ...
    private ReportReqData(Builder builder) {
        setAppid(builder.appid);
        setMch_id(builder.mch_id);
        setSub_mch_id(builder.sub_mch_id);
        setDevice_info(builder.device_info);
        setNonce_str(builder.nonce_str);
        setSign(builder.sign);
        setInterface_url(builder.interface_url);
        setExecute_time_cost(builder.execute_time_cost);
        setUser_ip(builder.user_ip);
        setTime(builder.time);
        setReturn_code(builder.return_code);
        setReturn_msg(builder.return_msg);
        setResult_code(builder.result_code);
        setErr_code(builder.err_code);
        setErr_code_des(builder.err_code_des);
        setOut_trade_no(builder.out_trade_no);
    }
    ...
    public static final class Builder {
        ...
        public Builder sub_mch_id(String val) {
            sub_mch_id = val;
            return this;
        }

        public Builder device_info(String val) {
            device_info = val;
            return this;
        }
        ...
        public Builder interface_url(String val) {
            interface_url = val;
            return this;
        }

        public Builder execute_time_cost(int val) {
            execute_time_cost = val;
            return this;
        }

        public Builder user_ip(String val) {
            user_ip = val;
            return this;
        }
        ...
        public Builder result_code(String val) {
            result_code = val;
            return this;
        }

        public Builder err_code(String val) {
            err_code = val;
            return this;
        }

        public Builder err_code_des(String val) {
            err_code_des = val;
            return this;
        }

        public Builder out_trade_no(String val) {
            out_trade_no = val;
            return this;
        }

        public ReportReqData build() {
            return new ReportReqData(this);
        }
    }
}
